...
class AlignmentPipeline:
    ...
    def __init__(self, model_name_or_path="slone/LaBSE-en-ru-myv-v2"):
        ...
        if torch.cuda.is_available():
            ...
            logger.warning(
                "CUDA is not available; sentence embedding is going to be slow"
            )
    ...
    def align_docs(
        self, src_text: str, tgt_text: str, rel_penalty=0.2, abs_penalty=0.2
    ) -> pd.DataFrame:
        ...
        sims, sims_rel = get_penalized_sims(
            src_sents,
            tgt_sents,
            src_embs,
            tgt_embs,
